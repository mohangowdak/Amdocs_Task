...
public class Tasks5 
{
	...
	@Test
	public void tasks5() throws InterruptedException {
		...
		driver.findElement(
				By.xpath("//p[contains(text(),'" + fromName + "') and @class='font14 appendBottom5 blackText']")).click();

		driver.findElement(By.xpath("//label[@for='toCity']")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@placeholder='To']")).sendKeys(toName);
		driver.findElement(By.xpath("//p[contains(text(),'" + toName + "') and @class='font14 appendBottom5 blackText']")).click();
		...
		Set<String> wins = driver.getWindowHandles();
	     java.util.Iterator<String> tabs = wins.iterator();
		while (tabs.hasNext()) {
		...
		driver.findElement(By.id("username")).sendKeys("8073798644");
		
		driver.findElement(By.xpath("//span[.='Continue']")).click();
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//input[@placeholder='Enter OTP here']")).sendKeys("807377");
